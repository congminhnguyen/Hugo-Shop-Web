...
@section('content')
                            ...
                            <div class="wrap-slick3-dots">
                                <ul class="slick3-dots" style="" role="tablist">
                                    ...
                                    {{-- <li class="" role="presentation">
                                        <img src="https://cdn.tgdd.vn/Products/Images/44/223654/acer-aspire-a315-56-308n-i3-nxhs5sv00c-1-2-org.jpg">
                                        <div class="slick3-dot-overlay"></div>
                                    </li> --}}
                                </ul>
                            </div>
                                ...
                                <div class="slick-list draggable">
                                    <div class="slick-track" style="opacity: 1; width: 1539px;">
                                        <div class="item-slick3 slick-slide slick-current slick-active"
                                            ...
                                            aria-hidden="false"
                                            style="width: 512px; position: relative; left: 0px; top: 0px; z-index: 999; opacity: 1;"
    ...
    <section class="sec-relate-product bg0 p-t-45 p-b-105">
        <div class="container">
            <div class="p-b-45">
                <h3 class="ltext-106 cl5 txt-center" style="font-family: 'Times New Roman', Times, serif">
                    Sản Phẩm Tương Tự
                </h3>
            </div>
